...
if __name__ == '__main__':
    ...
    #print(output['N_b']['topW_v3'].sum("dataset")[2:].values()[()].sum()+output['N_b']['TTW'].sum("dataset")[2:].values()[()].sum()+output['N_b']['ttbar'].sum("dataset")[2:].values()[()].sum())
    #print(output['N_b']['topW_v3'].sum("dataset")[2:].values()[()].sum()/(output['N_b']['TTW'].sum("dataset")[2:].values()[()].sum()+output['N_b']['ttbar'].sum("dataset")[2:].values()[()].sum()))
    #print(output['N_b']['topW_v3'].sum("dataset").values()[()])
    #print(output['N_b']['TTW'].sum("dataset").values()[()])
    #print(output['N_b']['ttbar'].sum("dataset").values()[()])
