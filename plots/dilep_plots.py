...
for name in histograms:
    ...
    if name == 'N_ele':
        ...
        # rebin
        axis = 'pt'
        new_met_bins = hist.Bin('pt', r'$trailing \ lep \ pt \ (GeV)$', 20, 0, 200)
        histogram = histogram.rebin('pt', new_met_bins)
    elif name == 'leading_electron_pt':
        # rebin
        axis = 'pt'
        new_met_bins = hist.Bin('pt', r'$leading \ electron \ pt \ (GeV)$', 20, 0, 200)
        histogram = histogram.rebin('pt', new_met_bins)
    elif name == 'leading_muon_pt':
        # rebin
        axis = 'pt'
        new_met_bins = hist.Bin('pt', r'$leading \ muon \ pt \ (GeV)$', 20, 0, 200)
        histogram = histogram.rebin('pt', new_met_bins)
    elif name == 'leading_spectator_pt':
        # rebin
        axis = 'pt'
        new_met_bins = hist.Bin('pt', r'$Spectator \ pt \ (GeV)$', 20, 0, 200)
        histogram = histogram.rebin('pt', new_met_bins)
    elif name == 'fw_pt':
        # rebin
        axis = 'pt'
        new_met_bins = hist.Bin('pt', r'$forward \ pt \ (GeV)$', 20, 0, 200)
        histogram = histogram.rebin('pt', new_met_bins)
    elif name == 'fw_eta':
        # rebin
        axis = 'eta'
        ...
        # rebin
        axis = 'eta'
        new_eta_bins = hist.Bin("eta", r"$fw jet delta\eta$", 30, -5.5, 5.5)
        histogram = histogram.rebin('eta', new_eta_bins)
...
#        # rebin
#        axis = 'pt'
#        new_pt_bins = hist.Bin('eta', r'$\eta$', 30, -5.5, 5.5)
#        histogram = histogram.rebin('pt',hist.Bin('pt', r'pt', 30, -5.5, 5.5))
