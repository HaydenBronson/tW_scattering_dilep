...
class forwardJetAnalyzer(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        leading_electron_idx = ak.singletons(ak.argmax(electron.p4.pt, axis=1))
        leading_electron = electron[leading_electron_idx]
        trailing_electron_idx = ak.singletons(ak.argmin(electron.p4.pt, axis=1))
...
#        BL = sel.dilep_baseline(cutflow=cutflow, SS=False)
        ...
        output['leading_electron_dxy'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.dxy))[BL], weight=weight.weight()[BL])
        output['leading_electron_dz'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.dz))[BL], weight=weight.weight()[BL])
        output['leading_electron_sip3d'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.sip3d))[BL], weight=weight.weight()[BL])
        output['leading_electron_miniPFRelIso_all'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.miniPFRelIso_all))[BL], weight=weight.weight()[BL])
        output['leading_electron_sieie'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.sieie))[BL], weight=weight.weight()[BL])
        output['leading_electron_hoe'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.hoe))[BL], weight=weight.weight()[BL])
        output['leading_electron_eInvMinusPInv'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.eInvMinusPInv))[BL], weight=weight.weight()[BL])
        output['leading_electron_mvaTTH'].fill(dataset=dataset, multiplicity=(pad_and_flatten(leading_electron.mvaTTH))[BL], weight=weight.weight()[BL])
        
        output['trailing_electron_dxy'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.dxy))[BL], weight=weight.weight()[BL])
        output['trailing_electron_dz'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.dz))[BL], weight=weight.weight()[BL])
        output['trailing_electron_sip3d'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.sip3d))[BL], weight=weight.weight()[BL])
        output['trailing_electron_miniPFRelIso_all'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.miniPFRelIso_all))[BL], weight=weight.weight()[BL])
        output['trailing_electron_sieie'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.sieie))[BL], weight=weight.weight()[BL])
        output['trailing_electron_hoe'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.hoe))[BL], weight=weight.weight()[BL])
        output['trailing_electron_eInvMinusPInv'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.eInvMinusPInv))[BL], weight=weight.weight()[BL])
        output['trailing_electron_mvaTTH'].fill(dataset=dataset, multiplicity=(pad_and_flatten(trailing_electron.mvaTTH))[BL], weight=weight.weight()[BL])
...
if __name__ == '__main__':
    ...
    for rle in ['run', 'lumi', 'event']:
        desired_output.update({
                ...
                "leading_electron_dxy": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_dz": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_sip3d": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_miniPFRelIso_all": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_sieie": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_hoe": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_eInvMinusPInv": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "leading_electron_mvaTTH": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_dxy": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_dz": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_sip3d": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_miniPFRelIso_all": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_sieie": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_hoe": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_eInvMinusPInv": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
                "trailing_electron_mvaTTH": hist.Hist("Counts", dataset_axis, small_multiplicity_axis),
